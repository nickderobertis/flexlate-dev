...
COPIER_OUTPUT_SUBDIR_NAME = "output_subdir"
...
DIFF_INPUT_FOLDER = INPUT_FILES_DIR / "diff"
MODIFIED_FILE = DIFF_INPUT_FOLDER / "setup.cfg"
RENAMED_FILE = DIFF_INPUT_FOLDER / "gitutils.py"
RENAMED_AND_MODIFIED_FILE = DIFF_INPUT_FOLDER / "server.py"
